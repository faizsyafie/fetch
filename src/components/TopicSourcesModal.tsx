        ...
        <div className="flex items-center justify-between border-b border-brand-200 px-4 py-3 dark:border-brand-800">
          ...
          <div className="flex shrink-0 items-center gap-3">
            <button
              ...
              className="text-[11px] text-brand-400 transition-colors hover:text-brand-700 disabled:cursor-not-allowed disabled:opacity-40 dark:hover:text-brand-200"
            >
              Reset defaults
            </button>
            <button
                ...
                {sources.map((source) => (
                  ...
                  >
                    <div className="min-w-0">
                      ...
                      <p className="truncate text-[10px] text-brand-400 dark:text-brand-500">
                        {source.feedUrl}
                      </p>
                    </div>
                    <button
